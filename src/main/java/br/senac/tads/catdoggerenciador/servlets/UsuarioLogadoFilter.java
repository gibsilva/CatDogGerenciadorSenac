...
// * @author Gi
// */
//@WebFilter(filterName = "UsuarioLogadoFilter", urlPatterns = {"/*"})
...
//
//        if (paginaAcessada.endsWith("/alterar-produto") || paginaAcessada.endsWith("/incluir-produto")) {
//            return true;
//        }
//        return false;
//    }
...
//            return ("UsuarioLogadoFilter()");
//        }
//        StringBuilder sb = new StringBuilder("UsuarioLogadoFilter(");
