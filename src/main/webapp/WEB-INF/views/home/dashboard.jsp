<%-- 
    Document   : DashboardExe
    Created on : Sep 19, 2019, 2:06:33 PM
    Author     : Girlaine
--%>
...
<div class="main-panel ps-container ps-theme-default ps-active-y" data-ps-id="794d9dcb-ce48-3d37-0fe3-3de8f615cdc5">
    ...
    <div class="content">
        <div class="container-fluid">
            <h3>Bem vindo, ${sessionScope.usuarioLogado.nome}</h3>
            <div class="row">
